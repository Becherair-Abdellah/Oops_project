...
function createPost(imguser, nameUser, timeCrtPost, textPost, imgPost, number_up, number_down, number_comments, commentsPost, iconPublic,idPOst,align) {
   ...
   let data = await response.json();
    ...
    for(let post of data.posts){
        ...
        createPost("../static/imgs/imgcode/linkedin.jpg", post.auther.user_name, '15 oct 2023', `${post.content}`
            , paths_img, 200, 10, 4, '',default_img,post.id,post.ild);
    }
}
getPosts();
controlTop();
